...
function Forms() {
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      setLoading(true)
      try {
        const response = await axios.post(`https://ayushiconstruction.com/api/contact`, {
          name: name,
          email: email,
          mobile_no: mobile_no,
         subject: subject,
          ...
          <div className="row d-flex align-items-center">
            <div className=" Address-detail col-md-4 fs-bold pt-5" data-aos="fade-right" data-aos-offset="60" data-aos-easing="ease-in-sine">
              ...
              <div className="pb-5">
                ...
                <h6>
                  mail us: <a href="mailto:infoayushiconstruction@gmail.com">infoayushiconstruction@gmail.com</a>
                </h6>
              </div>
            </div>
